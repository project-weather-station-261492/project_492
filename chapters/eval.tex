...
\section{สถานีวัดสภาพอากาศขนาดย่อม}
   ...
   \begin{figure}[H]
    ...
    \end{figure}
     \begin{figure}[H]
        \centering
        \includegraphics[width=0.7\textwidth]{picture/Hardware_overview.png}
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item เมนู Sunlight \& Solar Temp , Temp \& Humidity, Pressure, Wind Speed, Wind Direction เป็นเมนูแสดงข้อมูลที่ถูกส่งมาจากสถานีวัดสภาพอากาศขนาดย่อมรายชั่วโมง
    \end{itemize}
    \begin{figure}[H]
        \centering
    ...
    \begin{figure}[H]
        ...
        \caption{หน้าจอแสดงผลเมื่อผู้ใช้เลือกเมนู Sunlight \& Solar Temp}
...
\section{ผลการทดลอง Machine Learning}
\begin{itemize}
...
สถานีวัดสภาพอากาศขนาดย่อมที่สร้างขึ้นสามารถเก็บข้อมูลได้อย่างถูกต้องและส่งข้อมูลสม่ำเสมอทุก 1 ชั่วโมง แม้ว่าจะพบความแปรปรวนจากสภาพอากาศ เช่น ฝนตก อย่างไรก็ตาม เนื่องจากสถานีเพิ่งติดตั้งทำให้มีข้อมูลย้อนหลังจำกัด ส่งผลให้ต้องใช้ข้อมูลสภาพอากาศจาก API มาใช้ในการฝึกฝนโมเดลแทนซึ่งทำให้เกิดความคลาดเคลื่อนเมื่อทดสอบกับข้อมูลจริงของสถานี
